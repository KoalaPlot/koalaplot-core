...
[![Dokka docs](https://img.shields.io/badge/docs-dokka-278ec7)](https://koalaplot.github.io/koalaplot-core/api/0.10.1/)
...
```kotlin
dependencies {
    implementation("io.github.koalaplot:koalaplot-core:0.10.1")
}
```
...
- [Latest build](https://koalaplot.github.io/koalaplot-core/api/0.10.1)
- [Release 0.10.1](https://koalaplot.github.io/koalaplot-core/api/0.10.1)
