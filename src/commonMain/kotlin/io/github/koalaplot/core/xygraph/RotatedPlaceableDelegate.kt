...
/**
 * A delegate for a rotated Composable area (e.g. Placeable). In Compose, the rotate modifier
...
internal open class RotatedComposableAreaDelegate(private val area: IntSize, private val rotation: Float) {
    ...
    protected val anchorPositions = buildMap {
        ...
        put(AnchorPoint.TopCenter, Vector(0f, -area.height / 2f).rotate(rotation))
        put(AnchorPoint.TopRight, Vector(area.width / 2f, -area.height / 2f).rotate(rotation))
    ...
    /**
     * Returns the overall height of the rotated area.
     */
    ...
    /**
     * Returns the overall width of the rotated area.
     */
    ...
    /**
     * Returns the height of the area above the specified anchor point
     */
    ...
    /**
     * Returns the height of the area below the specified anchor point.
     */
    ...
    /**
     * Returns the width of the area to the right of the specified anchor point.
     */
    ...
    /**
     * Returns the width of the area to the left of the specified anchor point.
     */
